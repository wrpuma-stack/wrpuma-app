...
function dibujarMenu() {
    ...
    <div class="min-h-screen bg-black p-6 text-white text-center flex flex-col font-sans pb-10">
        <h1 class="text-5xl font-black italic mb-2">${tituloMenu}</h1><p class="text-zinc-600 text-[9px] font-bold uppercase tracking-[0.3em] mb-6">Elite Management ${rol === 'super' ? '- SUPERVISOR' : ''}</p>
        ...
        <div class="grid grid-cols-2 gap-4 max-w-sm mx-auto text-left mb-4">
            ...
            <button onclick="window.location.hash='#obras'" class="col-span-2 bg-zinc-900 text-white py-4 rounded-2xl font-black text-[12px] border border-zinc-800">VER PROYECTOS</button>
        </div>` : ``}
