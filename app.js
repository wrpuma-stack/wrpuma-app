...
function dibujarPlanilla() {
    ...
    data.obtenerTodo((db) => {
        ...
        list.forEach(n => {
            ...
            // LA CLAVE: Si las multas por atraso están apagadas, horasDescontar es 0.
